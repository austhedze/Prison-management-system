...
// Query to get total offenses and gender breakdown
...
// Fetch results for offenses and gender
...
<head>
    ...
    <title>Inmate Report with Visitation Logs</title>
    <style>
...
<body>
    <h1>Inmate Report</h1>
    <p><strong>Total Offenses:</strong> $totalOffenses</p>
...
$htmlContent .= "
    <footer>
        <p>Generated by Prison Information Management System(Group-3) &copy; " . date("Y") . "</p>
    </footer>
</body>
</html>";
