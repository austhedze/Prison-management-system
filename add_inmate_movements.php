...
if (isset($_POST['submit'])) {
    ...
    $inmate_image = $_FILES['inmate_image']['name'];
    ...
    if ($check !== false) {
        ...
        if (move_uploaded_file($_FILES["inmate_image"]["tmp_name"], $target_file)) {
            $sql = "INSERT INTO inmateManagement (inmate_name, disciplinary_records, previous_cell, new_cell, transfer_reason, inmate_image) 
