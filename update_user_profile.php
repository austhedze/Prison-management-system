...
if (isset($_POST['update'])) {
    ...
    $profile_picture = $_FILES['user_profile_picture'];
    ...
    if ($profile_picture['name']) {
        ...
        $target_file = $admin['user_profile_picture']; // Keep existing picture if not updated
    }

    // Update admin information
    $sql = "UPDATE users SET firstname='$firstname', lastname='$lastname', user_profile_picture='$target_file' WHERE username='$username'";
    ...
    <div class="container">
        ...
        <div class="content">
            <div class="avatar-container">
                <img src="<?php echo $user['user_profile_picture'] ? htmlspecialchars($user['user_profile_picture']) : 'icons/person.png'; ?>"
